      ...
      <div className="flex flex-col items-center text-center py-6 sm:py-10">
        ...
        <div className="space-y-6">
          <div className="relative inline-block">
            {/* ブランドタイトル */}
            <h1 className="text-4xl sm:text-5xl font-[1000] tracking-tighter leading-none text-slate-900">
              Blueprint English
            </h1>
            
            {/* センターバー */}
            <div className="mt-4 h-1 w-32 bg-linear-to-r from-indigo-600 via-indigo-500 to-purple-500 rounded-full mx-auto shadow-[0_2px_10px_-2px_rgba(79,70,229,0.3)]" />
          </div>
...
<div className="space-y-6 px-2">
  <div className="flex items-center justify-between px-2">
    <h2 className="text-xs font-black text-indigo-500 uppercase tracking-[0.2em] flex items-center gap-2">
      <div className="w-1 h-4 bg-indigo-500 rounded-full" /> {/* アクセントライン */}
      Picked for You
    </h2>
    <button 
      onClick={() => router.push('/student/library')}
      ...
      recommendations.map((corpus) => (
        <button
          ...
          className="group relative w-full text-left p-0.5 rounded-4xl transition-all duration-500
                     ...
                     hover:bg-linear-to-br hover:from-indigo-400 hover:via-slate-100 hover:via-50% hover:to-purple-500
