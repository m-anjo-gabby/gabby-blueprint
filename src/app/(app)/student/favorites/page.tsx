...
export default function FavoritePage() {
  ...
  return (
    <div className="w-full max-w-2xl min-w-2xl h-full flex flex-col bg-white rounded-[40px] shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden font-sans">
