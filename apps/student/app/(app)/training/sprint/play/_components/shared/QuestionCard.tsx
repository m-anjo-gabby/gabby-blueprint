                    ...
                    <div className="text-left border-l-4 border-emerald-500 bg-emerald-50/20 pl-4 pr-2 py-2 rounded-r-xl flex flex-col gap-1">
                      <div className="flex items-center w-full mb-0.5">
                        <div className="flex items-center gap-x-1.5 text-emerald-600">
                          ...
                          <button 
                            onClick={(e) => triggerAudio(e, question.answer_sentence_yes_voice, question.answer_sentence_yes_en)}
                            disabled={isAutoPlaying}
                            className="w-4 h-4 flex items-center justify-center text-emerald-500 hover:bg-emerald-100 rounded-full cursor-pointer"
                          >
                          ...
                          {question.answer_sentence_yes_ja && (
                            <button
                              ...
                              className={cn("w-5 h-5 flex items-center justify-center rounded-md transition-all cursor-pointer", showJaAnswer ? "bg-emerald-100 text-emerald-600" : "text-emerald-400/60 hover:text-emerald-600 hover:bg-emerald-100/50")}
                            >
                              <Languages size={12} />
                            </button>
                          )}
                      ...
                      <p className="text-lg sm:text-xl font-black text-emerald-700 leading-snug tracking-tight">
                        {showJaAnswer ? question.answer_sentence_yes_ja : question.answer_sentence_yes_en}
                      </p>
                    </div>
                    ...
                    <div className="text-left border-l-4 border-amber-500 bg-amber-50/20 pl-4 pr-2 py-2 rounded-r-xl flex flex-col gap-1">
                      <div className="flex items-center w-full mb-0.5">
                        <div className="flex items-center gap-x-1.5 text-amber-600">
                          ...
                          <button 
                            onClick={(e) => triggerAudio(e, question.answer_sentence_no_voice, question.answer_sentence_no_en || "")}
                            disabled={isAutoPlaying}
                            className="w-4 h-4 flex items-center justify-center text-amber-500 hover:bg-amber-100 rounded-full cursor-pointer"
                          >
                            <Volume2 size={11} strokeWidth={2.5} />
                          </button>
                          {question.answer_sentence_no_ja && (
                            <button
                              onClick={(e) => { e.stopPropagation(); setShowJaAnswer(!showJaAnswer); }}
                              className={cn("w-5 h-5 flex items-center justify-center rounded-md transition-all cursor-pointer", showJaAnswer ? "bg-amber-100 text-amber-600" : "text-amber-400/60 hover:text-amber-600 hover:bg-amber-100/50")}
                            >
                              <Languages size={12} />
                            </button>
                          )}
                      ...
                      <p className="text-lg sm:text-xl font-black text-amber-700 leading-snug tracking-tight">
                        {showJaAnswer ? question.answer_sentence_no_ja : question.answer_sentence_no_en}
                      </p>
                    </div>
                  </div>
                ) : (
                    ...
                    <div className="flex items-center w-full mb-0.5">
                      <div className="flex items-center gap-x-1.5 text-emerald-600">
                        ...
                        <button 
                          onClick={(e) => triggerAudio(e, question.answer_sentence_yes_voice, question.answer_sentence_yes_en || "")}
                          disabled={isAutoPlaying}
                          className="w-5 h-5 flex items-center justify-center rounded-full text-emerald-500 hover:bg-emerald-100 cursor-pointer"
                        >
                        ...
                        {question.answer_sentence_yes_ja && (
                          <button
                            onClick={(e) => { e.stopPropagation(); setShowJaAnswer(!showJaAnswer); }}
                            className={cn("w-6 h-6 flex items-center justify-center rounded-md transition-all cursor-pointer", showJaAnswer ? "bg-emerald-100 text-emerald-600" : "text-emerald-400/60 hover:text-emerald-600 hover:bg-emerald-100/50")}
                          >
                            <Languages size={13} />
                          </button>
                        )}
