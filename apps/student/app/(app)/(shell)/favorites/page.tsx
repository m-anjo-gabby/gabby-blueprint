// apps/student/app/(app)/(main)/favorites/page.tsx
'use client';
...
export default function FavoritePage() {
  ...
  return (
    <div className="w-full max-w-2xl h-full flex flex-col bg-white rounded-panel shadow-2xl border border-slate-100 overflow-hidden font-sans">
