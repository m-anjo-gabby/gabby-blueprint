                ...
                {isUserDropdownOpen && (
                  <>
                    ...
                    <motion.div 
                      ...
                      exit={{ opacity: 0, y: 4 }}
                      className="absolute left-0 right-0 mt-1.5 bg-white border border-slate-200 shadow-xl rounded-xl z-20 max-h-60 overflow-y-auto p-1.5 space-y-0.5"
                    >
                  ...
                  <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 text-[10px] font-bold text-slate-600 flex-wrap">
                        <span className="flex items-center gap-1 bg-blue-50/50 px-1.5 py-0.5 rounded-md border border-blue-100/40 text-slate-700">
                          <BookOpen size={11} className="text-blue-500 shrink-0" />
                          <span>単語数 <span className="font-mono font-black text-slate-900 text-xs">{totalWordsDay}</span></span>
                        </span>
