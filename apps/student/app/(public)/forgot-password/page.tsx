        ...
        <AnimatePresence mode="wait">
          ...
          {!success ? (
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-sm text-slate-500 mt-2 leading-relaxed">
                  登録時のメールアドレスを入力してください。リセット手順を送信します。
                </p>
              </div>
            ...
            >
              ...
              {/* 完了見出し */}
              <h1 className="text-xl font-bold text-slate-800各画面共通">メールを送信しました</h1>
