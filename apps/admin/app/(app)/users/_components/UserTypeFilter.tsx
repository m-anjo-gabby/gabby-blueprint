...
export default function UserTypeFilter() {
  ...
  return (
    <select
      ...
      className="h-9 shrink-0 px-3 border border-slate-200 rounded-md text-sm text-slate-700 bg-white shadow-sm focus:ring-1 focus:ring-brand-500 outline-none"
    >
