            ...
            {history.map((record) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[11px] font-black text-indigo-600 bg-indigo-50 border border-indigo-100 rounded-full px-2.5 py-1 shrink-0">
